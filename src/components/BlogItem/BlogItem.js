                    ...
                    <div className='d-flex'>
                        ...
                        <div>
                            ...
                            </p>
                            {
                                descriptionCollapse ?
                                    <span
                                        onClick={showLess} className='card-link collapse-btn'> Смотрите больше <FontAwesomeIcon className="icon" icon={faArrowAltCircleLeft} />
                                    </span>
                                    :
                                    <span
                                        onClick={showMore} className='card-link collapse-btn'>Смотрите больше <FontAwesomeIcon className="icon" icon={faArrowAltCircleRight} />
                                    </span>
                            }
                        </div>
                    </div>
